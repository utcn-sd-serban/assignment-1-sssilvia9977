...
public class StackUserSeed implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (repository.findAll().isEmpty()) {
			repository.save(new StackUser("A", "B", "A.B@example.com", "AB"));
			repository.save(new StackUser("C", "D", "C.D@example.com", "CD"));
			repository.save(new StackUser("E", "F", "E.F@example.com", "EF"));
			repository.save(new StackUser("Alex", "F", "E.F@example.com", "AlexF"));
		}
	}
}
